"""
Django settings for scheduler_2 project.
...
WSGI_APPLICATION = 'scheduler_2.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'USER': '',
        'PASSWORD': '',
        'HOST': 'postgres' if SERVER == 'prod' else '127.0.0.1',
